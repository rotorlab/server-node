[ ![flamebase/flamebase-database-server-cluster](https://d25lcipzij17d.cloudfront.net/badge.svg?id=js&type=6&v=1.0.4&x2=0)](https://www.npmjs.com/package/flamebase-database-server-cluster)
